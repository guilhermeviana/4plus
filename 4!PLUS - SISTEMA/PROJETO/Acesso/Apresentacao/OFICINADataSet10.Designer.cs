...
namespace Apresentacao.OFICINADataSet10TableAdapters {
    ...
    public partial class OSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[OS] WHERE (([ID_OS] = @Original_ID_OS) AND ((@IsNull_ID_CLIENT" +
                ...
                ")) AND ((@IsNull_CADASTRO = 1 AND [CADASTRO] IS NULL) OR ([CADASTRO] = @Original" +
                "_CADASTRO)) AND ((@IsNull_VALOR_TOTAL = 1 AND [VALOR_TOTAL] IS NULL) OR ([VALOR_" +
                "TOTAL] = @Original_VALOR_TOTAL)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[OS] ([ID_CLIENTE], [ID_DEFEITO], [ID_VEICULO], [ID_MECANICA], [DATA], [STATUS_OS], [NOME_CLIENTE], [CPF_CLIENTE], [PLACA_CLIENTE], [MARCA_CLIENTE], [MODELO_CLIENTE], [ANO_CLIENTE], [NOME_MECANICA], [NOME_DEFEITO], [DESCRIÇÃO_DEFEITO], [VALOR_DEFEITO], [VALOR_MECANICA], [VALOR_OFICINA], [CADASTRO], [VALOR_TOTAL]) VALUES (@ID_CLIENTE, @ID_DEFEITO, @ID_VEICULO, @ID_MECANICA, @DATA, @STATUS_OS, @NOME_CLIENTE, @CPF_CLIENTE, @PLACA_CLIENTE, @MARCA_CLIENTE, @MODELO_CLIENTE, @ANO_CLIENTE, @NOME_MECANICA, @NOME_DEFEITO, @DESCRIÇÃO_DEFEITO, @VALOR_DEFEITO, @VALOR_MECANICA, @VALOR_OFICINA, @CADASTRO, @VALOR_TOTAL);
SELECT ID_OS, ID_CLIENTE, ID_DEFEITO, ID_VEICULO, ID_MECANICA, DATA, STATUS_OS, NOME_CLIENTE, CPF_CLIENTE, PLACA_CLIENTE, MARCA_CLIENTE, MODELO_CLIENTE, ANO_CLIENTE, NOME_MECANICA, NOME_DEFEITO, DESCRIÇÃO_DEFEITO, VALOR_DEFEITO, VALOR_MECANICA, VALOR_OFICINA, CADASTRO, VALOR_TOTAL FROM OS WHERE (ID_OS = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[OS] SET [ID_CLIENTE] = @ID_CLIENTE, [ID_DEFEITO] = @ID_DEFEITO, [ID" +
                ...
                "ICINA] = @VALOR_OFICINA, [CADASTRO] = @CADASTRO, [VALOR_TOTAL] = @VALOR_TOTAL WH" +
                ...
                "] IS NULL) OR ([VALOR_OFICINA] = @Original_VALOR_OFICINA)) AND ((@IsNull_CADASTR" +
                "O = 1 AND [CADASTRO] IS NULL) OR ([CADASTRO] = @Original_CADASTRO)) AND ((@IsNul" +
                "l_VALOR_TOTAL = 1 AND [VALOR_TOTAL] IS NULL) OR ([VALOR_TOTAL] = @Original_VALOR" +
                ...
                " VALOR_MECANICA, VALOR_OFICINA, CADASTRO, VALOR_TOTAL FROM OS WHERE (ID_OS = @ID" +
                "_OS)";
        ...
        public virtual int Fill(OFICINADataSet10.OSDataTable dataTable) {
        ...
        public virtual OFICINADataSet10.OSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            OFICINADataSet10.OSDataTable dataTable = new OFICINADataSet10.OSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(OFICINADataSet10.OSDataTable dataTable) {
        ...
        public virtual int Delete(
            ...
            if ((Original_CADASTRO == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[38].Value = ((string)(Original_CADASTRO));
            }
            if ((Original_VALOR_TOTAL == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[40].Value = ((string)(Original_VALOR_TOTAL));
            }
        ...
        public virtual int Insert(
            ...
            if ((CADASTRO == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[18].Value = ((string)(CADASTRO));
            }
            if ((VALOR_TOTAL == null)) {
                this.Adapter.InsertCommand.Parameters[19].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[19].Value = ((string)(VALOR_TOTAL));
            }
        ...
        public virtual int Update(
            ...
            if ((CADASTRO == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(CADASTRO));
            }
            if ((VALOR_TOTAL == null)) {
                this.Adapter.UpdateCommand.Parameters[19].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(VALOR_TOTAL));
            }
            ...
            if ((Original_CADASTRO == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[58].Value = ((string)(Original_CADASTRO));
            }
            if ((Original_VALOR_TOTAL == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[60].Value = ((string)(Original_VALOR_TOTAL));
            }
